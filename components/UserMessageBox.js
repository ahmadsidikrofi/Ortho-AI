const UserMessageBox = ({ setEditContent, input, handleInputChange, handleSubmit }) => {
    ...
    return (
        <textarea
            className="flex-1 dark:bg-black bg-slate-100 dark:text-white text-slate-800 pt-3 pb-6 px-5 mb-8 rounded-[15px] shadow-xl mx-auto focus:outline-none focus:ring-0 placeholder:text-slate-800 dark:placeholder:text-stone-200 dark:caret-white caret-black resize-none scrollbar-hide"
            value={input}
